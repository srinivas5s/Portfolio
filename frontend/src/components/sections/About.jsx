...
import { PERSONAL_INFO, ABOUT_CARDS, STATS,
         EXPERIENCE, EDUCATION }                        from "../../constants/data";
    ...
    >
      ...
      <div
        className={[
          ...
          "group-hover:bg-[var(--accent-primary)]/5",
      ...
      {STATS.map((stat, i) => (
        <div
          ...
          className={[
            ...
            i < 2 ? "border-b sm:border-b-0 border-[var(--border-subtle)]" : "",
            "group hover:bg-[var(--bg-hover)] transition-colors duration-200",
          ].join(" ")}
        >
          {/* Stat number */}
          <span
          ...
          {/* Stat label */}
          <span
            className="font-mono text-[10px] tracking-widest text-[var(--text-tertiary)] uppercase mt-1.5"
          >
            {stat.label}
          </span>
        </div>
      ...
      <div className="flex flex-col items-center flex-shrink-0">
        ...
        <div
          className={[
            ...
            isExp
              ? "border-[var(--accent-secondary)] bg-[var(--bg-card)]"
              : "border-[var(--text-tertiary)] bg-[var(--bg-card)]",
          ].join(" ")}
          aria-hidden="true"
        />
        ...
        {!isLast && (
          <div
            className="w-[1px] flex-1 min-h-[2rem] mt-1 bg-[var(--border-subtle)]"
            aria-hidden="true"
          />
        )}
      </div>
      ...
      <div className="pb-8 flex-1 min-w-0">
        ...
        <div className="flex flex-wrap items-start justify-between gap-2 mb-1">
          <div>
            ...
            {/* Company / School */}
            <p className="font-medium text-sm text-[var(--text-secondary)] mt-0.5">
